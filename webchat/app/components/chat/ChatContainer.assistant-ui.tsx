  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[var(--bg-base)]">
          ...
          <div className="flex items-center gap-4 w-full">
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-[var(--text-secondary)] hover:text-[var(--accent-gold)] bg-[var(--bg-glass)] border border-[var(--border-default)] hover:border-[var(--accent-gold)]/30 rounded-full transition-all font-bold text-[10px] uppercase tracking-wider"
      ...
      <SettingsModal
        ...
        onSaved={() => {
          // Close modal after save — adapter will reconnect on next send
          // or user can manually trigger reconnect by selecting a session
        }}
      />
    </div>
  );
